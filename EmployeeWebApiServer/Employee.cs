...
namespace EmployeeWebApiServer
{
    public class Employee
    {
        ...
        public static Employee GetSingleEmployee(int EmpNo)
        {
            ...
            try
            {
                ...
                cmdInsert.Connection = cn;
                cmdInsert.CommandType = System.Data.CommandType.Text;
                cmdInsert.CommandText = "select * from emps where EmpNo=@EmpNo";
        ...
        public static void InsertEmployee(Employee obj)
        {
            ...
            try
            {
                ...
                cmdInsert.Connection = cn;
                cmdInsert.CommandType = System.Data.CommandType.Text;
                cmdInsert.CommandText = "insert into emps values(@EmpNo,@Name,@Basic,@DeptNo)";
        ...
        public static void UpdateEmployee(Employee obj)
        {
            ...
            try
            {
                ...
                cmdInsert.Connection = cn;
                cmdInsert.CommandType = System.Data.CommandType.Text;
                cmdInsert.CommandText = "update emps set EmpName=@Name, basic=@Basic, deptno=@Deptno where empno =@EmpNo";
        ...
        public static void DeleteEmployee(int EmpNo)
        {
            ...
            try
            {
                ...
                cmdInsert.Connection = cn;
                cmdInsert.CommandType = System.Data.CommandType.Text;
                cmdInsert.CommandText = "delete from emps where empno =@EmpNo";
